...
Shader "Shader Forge/001" {
    Properties {
        ...
        _node_2943 ("node_2943", Range(0, 1000)) = 92.27419
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float3 node_7190 = clamp((((sin((node_915.r*node_4407*_TimeMulitplier*_node_2943))*0.5+0.0)*(cos((node_915.g*node_4407*_TimeMulitplier*_node_2943))*0.5+0.0)*v.normal)*_VertexOffsetScalar),-1,1);
                ...
                float Tessellation(TessVertex v){
                    return (sin(_Tesselation)*_node_2943);
                }
